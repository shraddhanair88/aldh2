# Table 4 rs671.R
# Title: HYBRID EFFICIENT Workflow for rs671 Cohort
#
# Description:
...
# (which is faster than exporting full tables) and then loads them into R for
# analysis. This avoids common database connection errors while improving performance.
...
print("Comprehensive Demographic Table of Alcohol Consumption for rs671 Cohort")
print(table_with_totals)
write.csv(table_with_totals, "rs671_alcohol_demographics.csv")
